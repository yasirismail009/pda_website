      ...
      <Grid container spacing={2} className="justify-center items-center">
        <Grid item lg={6} xs={12}>
          <div className="flex flex-col justify-center items-center">
            <div>
              <p className="lg:text-4xl sm:text-3xl text-3xl font-bold text-primary-dark lg:ml-8 sm:ml-0 ml-0 mb-2">
                Security News
              </p>
              ...
              <p className="lg:text-xl sm:text-base text-base font-medium text-primary-dark lg:ml-16 sm:ml-0 ml-0  mb-8">
            ...
            <Link href="/blogs/?lead=123">
              <div className="lg:ml-16 sm:ml-0 ml-0 w-60 flex flex-row items-center justify-center cursor-pointer font-bold text-sm lg:px-6 sm:px-8 px-8 lg:py-2  sm:py-2 py-2 lg:mb-0 sm:mb-8 mb-8 text-primary-main bg-primary-dark hover:bg-primary-card   rounded-xl shadow-2xl">

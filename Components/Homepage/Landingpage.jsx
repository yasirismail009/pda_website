...
export default function LandingPage() {
  return (
    <div id="home" className="w-full mb-40 sm:px-4 px-4">
      <div className="w-full lg:flex md:flex flex-col sm:block block lg:h-screen sm:h-full h-full items-center justify-center lg:mt-2 sm:mt-0 mt-0">
        <div className="w-full flex items-center justify-center lg:mt-16 sm:mt-28 mt-28">
          <Image src={LandingImg} alt="Privacy Defender App" priority />
        </div>
        <div className="lg:text-6xl sm:text-4xl text-4xl font-bold lg:text-left sm:text-center text-center text-primary-dark mb-4 lg:mt-0 sm:mt-8 mt-8">
        ...
        <div className="lg-w-[40%] sm:w-full w-full flex lg:flex-row sm:flex-wrap flex-wrap items-center justify-center">
          <div className="lg:mb-0 sm:mb-4 mb-4">
            <div className="flex flex-row lg:ml-4 sm:ml-0 ml-0">
              ...
              <div className="text-[#ffc200] lg:text-5xl sm:text-2xl text-2xl font-bold lg:ml-4 sm:ml-2 ml-2">
                50K+
              </div>
          ...
          <div className="lg:mb-0 sm:mb-2 mb-2 lg:ml-0 sm:ml-2 ml-2">
            <div className="flex flex-row lg:ml-4 sm:ml-0 ml-0">
              ...
              <div className="text-[#ffc200] lg:text-5xl sm:text-2xl text-2xl  font-bold ml-4">
                4.9
              </div>
        ...
        <div className="flex flex-row mt-8  items-center justify-center">
          ...
          >
            <div className="flex flex-row items-center justify-center cursor-pointer font-bold text-sm lg:px-10 sm:px-5 px-5 lg:py-4  sm:py-1 py-1 text-primary-main bg-primary-dark hover:bg-primary-card   rounded-xl shadow-2xl">
              ...
              />
              <div className="lg:text-2xl sm:text-xs text-xs font-semibold lg:ml-4 sm:ml-2 ml-2">
                Play Store
              </div>
            </div>
          </a>
          <a
            ...
            target="_blank"
          >
            <div className="flex flex-row items-center justify-center cursor-pointer font-bold text-sm lg:px-10 sm:px-5 px-5 lg:py-4  sm:py-1 py-1 hover:bg-primary-text   rounded-xl shadow-md shadow-slate-400 lg:ml-8 sm:ml-2 ml-2">
              <Image
                src={AppleStoreIcon}
                alt="Privacy Defender App"
                className="lg:p-0 sm:p-1 p-1"
              />
              <div className="lg:text-2xl sm:text-base text-base font-semibold lg:ml-4 sm:ml-2 ml-2">
                Apple Store
              </div>
            </div>
          </a>
